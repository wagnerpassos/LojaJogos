 ...
 * @author wagne
 */
public class TelaTorneio extends javax.swing.JDialog {
     ...
     */
    public TelaTorneio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizaTabela();
        trataEdicao(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTorneio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaTorneio dialog = new TelaTorneio(new javax.swing.JFrame(), true);
